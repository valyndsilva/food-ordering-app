...
## Setup NextJS with MongoDB and TailwindCSS:

```
npx create-next-app --example with-mongodb food-ordering-app
cd food-ordering-app
npm install -D tailwindcss@latest postcss@latest autoprefixer@latest // Install Tailwind via npm
...
The connection_string looks like:
...
Create a models directory in the root.
...
## Create NextJS REST API with MongoDB:

We don't need to build any express server here.
We can use the pages/api folder from NextJS.
Create products and orders folders in pages/api and in each an index.js file:
...
### Update components/PizzaList.js:
...
### Update components/PizzaCard.js:
...
## Create API Endpoint for Single Product:

### In pages/api/products create [id].js
...
### Create components/OrderDetail.js:
...
### Update pages/admin/index.js with getServerSideProps:
...
### Update pages/api/products/index.tsx:
...
### Update pages/api/products/[id].js:
